/// Emulation of the NES' joypads

use bitflags::bitflags;

bitflags! {
    // https://wiki.nesdev.org/w/index.php/Controller_reading_code
    // Implemented in reverse order so that reading can be done easier in the intended order:
...
mod tests {
    ...
    #[test]
    fn test_joypad_strobe_mode_on_off() {
        let mut joypad = Joypad::new();
        joypad.write(0);
        ...
        joypad.set_button_status(JoypadButton::BUTTON_B, true);
